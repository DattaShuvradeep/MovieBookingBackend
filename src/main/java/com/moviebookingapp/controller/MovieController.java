...
import com.moviebookingapp.model.MessageResponse;
...
public class MovieController {
    ...
    public ResponseEntity<?> deleteMovie(@PathVariable("movieId") int movieId) {
        if (movieService.deleteMovie(movieId)) {
            return new ResponseEntity<MessageResponse>(new MessageResponse(("Movie got deleted successfully"), HttpStatus.OK),HttpStatus.OK);
        }
